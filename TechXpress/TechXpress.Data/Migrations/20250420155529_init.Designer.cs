...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechXpress.Data.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechXpress.Data.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TechXpress.Data.Models.Order", b =>
                {
                    b.HasOne("TechXpress.Data.Models.AppUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TechXpress.Data.Models.ShoppingCart", b =>
                {
                    b.HasOne("TechXpress.Data.Models.AppUser", "User")
                        ...
                        .HasForeignKey("TechXpress.Data.Models.ShoppingCart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
